  ...
  return (
    <section id="contact" className="py-20 bg-white text-center">
      <div className="container mx-auto">
        ...
        <div>
          <div
            className={`${montserrat.className} grid grid-cols-1 md:grid-cols-3 gap-8`}
          >
            <div>
              <MessageSquareMore className="mx-auto mb-2" width="30px" height="30px" color="#B91F25"/>
              <p className="mb-3 font-semibold">Etape 1 - Contact</p>
              <p>Contactez-nous sur WhatsApp, par e-mail ou par téléphone</p>
            </div>
            <div>
              <Coins className="mx-auto mb-2" width="30px" height="30px" color="#B91F25"/>
            ...
            <div>
              <LandPlot className="mx-auto mb-2" width="30px" height="30px" color="#B91F25"/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className={`${montserrat.className} mt-4 font-medium`}>
                via Whatsapp
              </p>
            </a>
            <a
